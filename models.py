...
class Message(db.Model):
    ...
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    attachment_path = db.Column(db.String(255), nullable=True)  # Path to stored attachment
    attachment_type = db.Column(db.String(50), nullable=True)  # Type of attachment (image, document, etc.)
